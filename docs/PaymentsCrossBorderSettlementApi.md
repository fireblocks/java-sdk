...
import com.fireblocks.sdk.PaymentsCrossBorderSettlementApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        PaymentsCrossBorderSettlementApi apiInstance = new PaymentsCrossBorderSettlementApi(configuration);
