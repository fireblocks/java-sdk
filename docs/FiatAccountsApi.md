...
> CompletableFuture<ApiResponse<FiatAccount>> getFiatAccount getFiatAccount(accountId)
...
> CompletableFuture<ApiResponse<List<FiatAccount>>> getFiatAccounts getFiatAccounts()
