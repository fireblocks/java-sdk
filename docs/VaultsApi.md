...
import com.fireblocks.sdk.VaultsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        VaultsApi apiInstance = new VaultsApi(configuration);
...
> VaultAccountsPagedResponse getPagedVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            VaultAccountsPagedResponse result = apiInstance.getPagedVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit);
            System.out.println(result);
        } catch (ApiException e) {
...
> List&lt;VaultAccount&gt; getVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String assetId = "assetId_example"; // String | 
        try {
            List<VaultAccount> result = apiInstance.getVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId);
            System.out.println(result);
        } catch (ApiException e) {
