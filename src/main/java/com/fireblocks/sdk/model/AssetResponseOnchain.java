...
public class AssetResponseOnchain {
    ...
    public AssetResponseOnchain symbol(@jakarta.annotation.Nonnull String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public AssetResponseOnchain name(@jakarta.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public AssetResponseOnchain address(@jakarta.annotation.Nullable String address) {
    ...
    public AssetResponseOnchain decimals(@jakarta.annotation.Nonnull BigDecimal decimals) {
        this.decimals = decimals;
        return this;
    }
    ...
    public AssetResponseOnchain standard(@jakarta.annotation.Nonnull String standard) {
        this.standard = standard;
        return this;
    }
