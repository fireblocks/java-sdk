...
public class Quote {
    ...
    public Quote(
            ...
            @JsonProperty(value = JSON_PROPERTY_TYPE, required = true) IndicativeQuoteEnum type) {
        this.via = via;
        this.id = id;
    ...
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public IndicativeQuoteEnum getType() {
        return type;
    }

    @JsonProperty(JSON_PROPERTY_TYPE)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setType(@jakarta.annotation.Nonnull IndicativeQuoteEnum type) {
        this.type = type;
    }
