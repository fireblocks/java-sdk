...
public class InvalidParamaterValueError {
    ...
    public InvalidParamaterValueError message(@jakarta.annotation.Nonnull String message) {
        this.message = message;
        return this;
    }
    ...
    public InvalidParamaterValueError code(@jakarta.annotation.Nonnull BigDecimal code) {
        this.code = code;
        return this;
    }
