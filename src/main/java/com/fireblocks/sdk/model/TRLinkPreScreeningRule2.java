...
@JsonPropertyOrder({
    TRLinkPreScreeningRule2.JSON_PROPERTY_CUSTOMER_ID,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DIRECTION,
    TRLinkPreScreeningRule2.JSON_PROPERTY_SOURCE_TYPE,
    TRLinkPreScreeningRule2.JSON_PROPERTY_SOURCE_SUB_TYPE,
    TRLinkPreScreeningRule2.JSON_PROPERTY_SOURCE_ADDRESS,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DEST_TYPE,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DEST_SUB_TYPE,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DEST_ADDRESS,
    TRLinkPreScreeningRule2.JSON_PROPERTY_SOURCE_ID,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DEST_ID,
    TRLinkPreScreeningRule2.JSON_PROPERTY_ASSET,
    TRLinkPreScreeningRule2.JSON_PROPERTY_BASE_ASSET,
    TRLinkPreScreeningRule2.JSON_PROPERTY_AMOUNT,
    TRLinkPreScreeningRule2.JSON_PROPERTY_NETWORK_PROTOCOL,
    TRLinkPreScreeningRule2.JSON_PROPERTY_OPERATION,
    TRLinkPreScreeningRule2.JSON_PROPERTY_DESCRIPTION,
    TRLinkPreScreeningRule2.JSON_PROPERTY_IS_DEFAULT,
    TRLinkPreScreeningRule2.JSON_PROPERTY_ACTION
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.14.0")
public class TRLinkPreScreeningRule2 {
    ...
    @jakarta.annotation.Nonnull private TRLinkPreScreeningAction2 action;

    public TRLinkPreScreeningRule2() {}

    @JsonCreator
    public TRLinkPreScreeningRule2(
            @JsonProperty(value = JSON_PROPERTY_ACTION, required = true)
                    TRLinkPreScreeningAction2 action) {
        this.action = action;
    }

    public TRLinkPreScreeningRule2 customerId(@jakarta.annotation.Nullable String customerId) {
    ...
    public TRLinkPreScreeningRule2 direction(
    ...
    public TRLinkPreScreeningRule2 sourceType(@jakarta.annotation.Nullable String sourceType) {
    ...
    public TRLinkPreScreeningRule2 sourceSubType(
    ...
    public TRLinkPreScreeningRule2 sourceAddress(
    ...
    public TRLinkPreScreeningRule2 destType(@jakarta.annotation.Nullable String destType) {
    ...
    public TRLinkPreScreeningRule2 destSubType(@jakarta.annotation.Nullable String destSubType) {
    ...
    public TRLinkPreScreeningRule2 destAddress(@jakarta.annotation.Nullable String destAddress) {
    ...
    public TRLinkPreScreeningRule2 sourceId(@jakarta.annotation.Nullable String sourceId) {
    ...
    public TRLinkPreScreeningRule2 destId(@jakarta.annotation.Nullable String destId) {
        this.destId = destId;
        return this;
    }
    ...
    public TRLinkPreScreeningRule2 asset(@jakarta.annotation.Nullable String asset) {
        this.asset = asset;
        return this;
    }
    ...
    public TRLinkPreScreeningRule2 baseAsset(@jakarta.annotation.Nullable String baseAsset) {
    ...
    public TRLinkPreScreeningRule2 amount(
    ...
    public TRLinkPreScreeningRule2 networkProtocol(
    ...
    public TRLinkPreScreeningRule2 operation(@jakarta.annotation.Nullable String operation) {
    ...
    public TRLinkPreScreeningRule2 description(@jakarta.annotation.Nullable String description) {
    ...
    public TRLinkPreScreeningRule2 isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
    ...
    public TRLinkPreScreeningRule2 action(
            @jakarta.annotation.Nonnull TRLinkPreScreeningAction2 action) {
        this.action = action;
        return this;
    }
    ...
    public TRLinkPreScreeningAction2 getAction() {
        return action;
    }

    @JsonProperty(JSON_PROPERTY_ACTION)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setAction(@jakarta.annotation.Nonnull TRLinkPreScreeningAction2 action) {
        this.action = action;
    }

    /** Return true if this TRLinkPreScreeningRule-2 object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        TRLinkPreScreeningRule2 trLinkPreScreeningRule2 = (TRLinkPreScreeningRule2) o;
        return Objects.equals(this.customerId, trLinkPreScreeningRule2.customerId)
                && Objects.equals(this.direction, trLinkPreScreeningRule2.direction)
                && Objects.equals(this.sourceType, trLinkPreScreeningRule2.sourceType)
                && Objects.equals(this.sourceSubType, trLinkPreScreeningRule2.sourceSubType)
                && Objects.equals(this.sourceAddress, trLinkPreScreeningRule2.sourceAddress)
                && Objects.equals(this.destType, trLinkPreScreeningRule2.destType)
                && Objects.equals(this.destSubType, trLinkPreScreeningRule2.destSubType)
                && Objects.equals(this.destAddress, trLinkPreScreeningRule2.destAddress)
                && Objects.equals(this.sourceId, trLinkPreScreeningRule2.sourceId)
                && Objects.equals(this.destId, trLinkPreScreeningRule2.destId)
                && Objects.equals(this.asset, trLinkPreScreeningRule2.asset)
                && Objects.equals(this.baseAsset, trLinkPreScreeningRule2.baseAsset)
                && Objects.equals(this.amount, trLinkPreScreeningRule2.amount)
                && Objects.equals(this.networkProtocol, trLinkPreScreeningRule2.networkProtocol)
                && Objects.equals(this.operation, trLinkPreScreeningRule2.operation)
                && Objects.equals(this.description, trLinkPreScreeningRule2.description)
                && Objects.equals(this.isDefault, trLinkPreScreeningRule2.isDefault)
                && Objects.equals(this.action, trLinkPreScreeningRule2.action);
    }
    ...
    public String toString() {
        ...
        sb.append("class TRLinkPreScreeningRule2 {\n");
