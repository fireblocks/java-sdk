...
@JsonDeserialize(using = TransactionRequestNetworkFee.TransactionRequestNetworkFeeDeserializer.class)
@JsonSerialize(using = TransactionRequestNetworkFee.TransactionRequestNetworkFeeSerializer.class)
public class TransactionRequestNetworkFee extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TransactionRequestNetworkFee.class.getName());

    public static class TransactionRequestNetworkFeeSerializer extends StdSerializer<TransactionRequestNetworkFee> {
        public TransactionRequestNetworkFeeSerializer(Class<TransactionRequestNetworkFee> t) {
            super(t);
        }

        public TransactionRequestNetworkFeeSerializer() {
            this(null);
        }

        @Override
        public void serialize(TransactionRequestNetworkFee value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransactionRequestNetworkFeeDeserializer extends StdDeserializer<TransactionRequestNetworkFee> {
        public TransactionRequestNetworkFeeDeserializer() {
            this(TransactionRequestNetworkFee.class);
        }

        public TransactionRequestNetworkFeeDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TransactionRequestNetworkFee deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TransactionRequestNetworkFee ret = new TransactionRequestNetworkFee();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for TransactionRequestNetworkFee: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TransactionRequestNetworkFee getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TransactionRequestNetworkFee cannot be null");
        }
    }
    ...
    public TransactionRequestNetworkFee() {
        super("oneOf", Boolean.FALSE);
    }

    public TransactionRequestNetworkFee(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TransactionRequestNetworkFee(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TransactionRequestNetworkFee.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return TransactionRequestNetworkFee.schemas;
    }
