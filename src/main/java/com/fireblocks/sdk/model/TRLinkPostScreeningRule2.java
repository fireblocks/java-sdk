...
@JsonPropertyOrder({
    TRLinkPostScreeningRule2.JSON_PROPERTY_CUSTOMER_ID,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DIRECTION,
    TRLinkPostScreeningRule2.JSON_PROPERTY_SOURCE_TYPE,
    TRLinkPostScreeningRule2.JSON_PROPERTY_SOURCE_SUB_TYPE,
    TRLinkPostScreeningRule2.JSON_PROPERTY_SOURCE_ADDRESS,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DEST_TYPE,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DEST_SUB_TYPE,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DEST_ADDRESS,
    TRLinkPostScreeningRule2.JSON_PROPERTY_SOURCE_ID,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DEST_ID,
    TRLinkPostScreeningRule2.JSON_PROPERTY_ASSET,
    TRLinkPostScreeningRule2.JSON_PROPERTY_BASE_ASSET,
    TRLinkPostScreeningRule2.JSON_PROPERTY_AMOUNT,
    TRLinkPostScreeningRule2.JSON_PROPERTY_NETWORK_PROTOCOL,
    TRLinkPostScreeningRule2.JSON_PROPERTY_OPERATION,
    TRLinkPostScreeningRule2.JSON_PROPERTY_DESCRIPTION,
    TRLinkPostScreeningRule2.JSON_PROPERTY_IS_DEFAULT,
    TRLinkPostScreeningRule2.JSON_PROPERTY_PROVIDER_IDENT,
    TRLinkPostScreeningRule2.JSON_PROPERTY_TRM_STATUS,
    TRLinkPostScreeningRule2.JSON_PROPERTY_VALID_BEFORE,
    TRLinkPostScreeningRule2.JSON_PROPERTY_VALID_AFTER,
    TRLinkPostScreeningRule2.JSON_PROPERTY_ACTION
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.14.0")
public class TRLinkPostScreeningRule2 {
    ...
    public TRLinkPostScreeningRule2(
            @JsonProperty(value = JSON_PROPERTY_ACTION, required = true)
                    TRLinkPostScreeningAction action) {
        this.action = action;
    }

    public TRLinkPostScreeningRule2 customerId(@jakarta.annotation.Nullable String customerId) {
    ...
    public TRLinkPostScreeningRule2 direction(
    ...
    public TRLinkPostScreeningRule2 sourceType(@jakarta.annotation.Nullable String sourceType) {
    ...
    public TRLinkPostScreeningRule2 sourceSubType(
    ...
    public TRLinkPostScreeningRule2 sourceAddress(
    ...
    public TRLinkPostScreeningRule2 destType(@jakarta.annotation.Nullable String destType) {
    ...
    public TRLinkPostScreeningRule2 destSubType(@jakarta.annotation.Nullable String destSubType) {
    ...
    public TRLinkPostScreeningRule2 destAddress(@jakarta.annotation.Nullable String destAddress) {
    ...
    public TRLinkPostScreeningRule2 sourceId(@jakarta.annotation.Nullable String sourceId) {
    ...
    public TRLinkPostScreeningRule2 destId(@jakarta.annotation.Nullable String destId) {
        this.destId = destId;
        return this;
    }
    ...
    public TRLinkPostScreeningRule2 asset(@jakarta.annotation.Nullable String asset) {
        this.asset = asset;
        return this;
    }
    ...
    public TRLinkPostScreeningRule2 baseAsset(@jakarta.annotation.Nullable String baseAsset) {
    ...
    public TRLinkPostScreeningRule2 amount(
            @jakarta.annotation.Nullable ScreeningPolicyAmount amount) {
        this.amount = amount;
        return this;
    }
    ...
    public TRLinkPostScreeningRule2 networkProtocol(
    ...
    public TRLinkPostScreeningRule2 operation(@jakarta.annotation.Nullable String operation) {
    ...
    public TRLinkPostScreeningRule2 description(@jakarta.annotation.Nullable String description) {
    ...
    public TRLinkPostScreeningRule2 isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
    ...
    public TRLinkPostScreeningRule2 providerIdent(
    ...
    public TRLinkPostScreeningRule2 trmStatus(
            @jakarta.annotation.Nullable TRLinkTrmStatus trmStatus) {
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public TRLinkTrmStatus getTrmStatus() {
        return trmStatus;
    }

    @JsonProperty(JSON_PROPERTY_TRM_STATUS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTrmStatus(@jakarta.annotation.Nullable TRLinkTrmStatus trmStatus) {
        this.trmStatus = trmStatus;
    }
    ...
    public TRLinkPostScreeningRule2 action(
            @jakarta.annotation.Nonnull TRLinkPostScreeningAction action) {
        this.action = action;
        return this;
    }
    ...
    public TRLinkPostScreeningAction getAction() {
        return action;
    }

    @JsonProperty(JSON_PROPERTY_ACTION)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setAction(@jakarta.annotation.Nonnull TRLinkPostScreeningAction action) {
        this.action = action;
    }

    /** Return true if this TRLinkPostScreeningRule-2 object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        TRLinkPostScreeningRule2 trLinkPostScreeningRule2 = (TRLinkPostScreeningRule2) o;
        return Objects.equals(this.customerId, trLinkPostScreeningRule2.customerId)
                && Objects.equals(this.direction, trLinkPostScreeningRule2.direction)
                && Objects.equals(this.sourceType, trLinkPostScreeningRule2.sourceType)
                && Objects.equals(this.sourceSubType, trLinkPostScreeningRule2.sourceSubType)
                && Objects.equals(this.sourceAddress, trLinkPostScreeningRule2.sourceAddress)
                && Objects.equals(this.destType, trLinkPostScreeningRule2.destType)
                && Objects.equals(this.destSubType, trLinkPostScreeningRule2.destSubType)
                && Objects.equals(this.destAddress, trLinkPostScreeningRule2.destAddress)
                && Objects.equals(this.sourceId, trLinkPostScreeningRule2.sourceId)
                && Objects.equals(this.destId, trLinkPostScreeningRule2.destId)
                && Objects.equals(this.asset, trLinkPostScreeningRule2.asset)
                && Objects.equals(this.baseAsset, trLinkPostScreeningRule2.baseAsset)
                && Objects.equals(this.amount, trLinkPostScreeningRule2.amount)
                && Objects.equals(this.networkProtocol, trLinkPostScreeningRule2.networkProtocol)
                && Objects.equals(this.operation, trLinkPostScreeningRule2.operation)
                && Objects.equals(this.description, trLinkPostScreeningRule2.description)
                && Objects.equals(this.isDefault, trLinkPostScreeningRule2.isDefault)
                && Objects.equals(this.providerIdent, trLinkPostScreeningRule2.providerIdent)
                && Objects.equals(this.trmStatus, trLinkPostScreeningRule2.trmStatus)
                && Objects.equals(this.validBefore, trLinkPostScreeningRule2.validBefore)
                && Objects.equals(this.validAfter, trLinkPostScreeningRule2.validAfter)
                && Objects.equals(this.action, trLinkPostScreeningRule2.action);
    }
    ...
    public String toString() {
        ...
        sb.append("class TRLinkPostScreeningRule2 {\n");
