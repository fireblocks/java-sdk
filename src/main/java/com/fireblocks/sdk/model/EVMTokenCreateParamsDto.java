  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contractId, evMTokenCreateParamsDto.contractId) &&
        Objects.equals(this.constructorParams, evMTokenCreateParamsDto.constructorParams);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getContractId() != null) {
      joiner.add(String.format("%scontractId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getContractId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getConstructorParams() != null) {
      for (int i = 0; i < getConstructorParams().size(); i++) {
        if (getConstructorParams().get(i) != null) {
          joiner.add(String.format("%sconstructorParams%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
              URLEncoder.encode(String.valueOf(getConstructorParams().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
      }
    }
