...
public class AssetResponseMetadata {
    ...
    public AssetResponseMetadata scope(@jakarta.annotation.Nonnull ScopeEnum scope) {
        this.scope = scope;
        return this;
    }
    ...
    public AssetResponseMetadata deprecated(@jakarta.annotation.Nonnull Boolean deprecated) {
        this.deprecated = deprecated;
        return this;
    }
