...
public class CreateWalletRequest {
    ...
    public CreateWalletRequest name(@jakarta.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateWalletRequest customerRefId(@jakarta.annotation.Nullable String customerRefId) {
