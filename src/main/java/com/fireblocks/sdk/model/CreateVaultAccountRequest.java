...
public class CreateVaultAccountRequest {
    ...
    /**
     * Type of vault account. The default type will be set to MPC. If the workspace does not support
     * the selected type, it will return an error.
     */
     ...
     * ignored. If set to true and there are available keys, random keys will be assigned to the
     * newly created vault account. If set to true and there are no available keys to be assigned,
     * it will return an error. If set to false, the vault account will be created without any keys.
     *
     * @return autoAssign
     */
    @jakarta.annotation.Nullable
