...
/** CreateOffersRequest */
@JsonPropertyOrder({
    CreateOffersRequest.JSON_PROPERTY_BASE_ASSET_ID,
    CreateOffersRequest.JSON_PROPERTY_BASE_ASSET_RAIL,
    CreateOffersRequest.JSON_PROPERTY_QUOTE_ASSET_ID,
    CreateOffersRequest.JSON_PROPERTY_QUOTE_ASSET_RAIL,
    CreateOffersRequest.JSON_PROPERTY_BASE_AMOUNT,
    CreateOffersRequest.JSON_PROPERTY_SLIPPAGE_BPS,
    CreateOffersRequest.JSON_PROPERTY_SETTLEMENT,
    CreateOffersRequest.JSON_PROPERTY_SIDE
})
...
public class CreateOffersRequest {
    ...
    @jakarta.annotation.Nullable private Integer slippageBps = 50;
    ...
    public CreateOffersRequest baseAssetId(@jakarta.annotation.Nonnull String baseAssetId) {
        this.baseAssetId = baseAssetId;
        return this;
    }
    ...
    public CreateOffersRequest baseAssetRail(
    ...
    public CreateOffersRequest quoteAssetId(@jakarta.annotation.Nonnull String quoteAssetId) {
        this.quoteAssetId = quoteAssetId;
        return this;
    }
    ...
    public CreateOffersRequest quoteAssetRail(
    ...
    public CreateOffersRequest baseAmount(@jakarta.annotation.Nonnull String baseAmount) {
        this.baseAmount = baseAmount;
        return this;
    }
    ...
    public CreateOffersRequest slippageBps(@jakarta.annotation.Nullable Integer slippageBps) {
        this.slippageBps = slippageBps;
        return this;
    }

    /**
     * Slippage tolerance in basis points (bps) for defi quotes - 1 is 0.01% and 10000 is 100%. If
     * not set, defaults to 50 bps (0.5%). minimum: 1 maximum: 10000
     *
     * @return slippageBps
     */
    @jakarta.annotation.Nullable
    ...
    public CreateOffersRequest settlement(@jakarta.annotation.Nullable DVPSettlement settlement) {
    ...
    public CreateOffersRequest side(@jakarta.annotation.Nonnull Side side) {
        this.side = side;
        return this;
    }
    ...
    /** Return true if this CreateOffersRequest object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.baseAssetId, createOffersRequest.baseAssetId)
                && Objects.equals(this.baseAssetRail, createOffersRequest.baseAssetRail)
                && Objects.equals(this.quoteAssetId, createOffersRequest.quoteAssetId)
                && Objects.equals(this.quoteAssetRail, createOffersRequest.quoteAssetRail)
                && Objects.equals(this.baseAmount, createOffersRequest.baseAmount)
                && Objects.equals(this.slippageBps, createOffersRequest.slippageBps)
                && Objects.equals(this.settlement, createOffersRequest.settlement)
                && Objects.equals(this.side, createOffersRequest.side);
    }
