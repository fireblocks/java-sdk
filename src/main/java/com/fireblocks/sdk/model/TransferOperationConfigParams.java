...
public class TransferOperationConfigParams {
    ...
    @jakarta.annotation.Nonnull private Destination destination;
    ...
    public TransferOperationConfigParams amount(@jakarta.annotation.Nullable String amount) {
        this.amount = amount;
        return this;
    }
    ...
    public TransferOperationConfigParams assetId(@jakarta.annotation.Nullable String assetId) {
    ...
    public TransferOperationConfigParams source(@jakarta.annotation.Nullable Account source) {
        this.source = source;
        return this;
    }
    ...
    public TransferOperationConfigParams destination(
            @jakarta.annotation.Nonnull Destination destination) {
        this.destination = destination;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_DESTINATION)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setDestination(@jakarta.annotation.Nonnull Destination destination) {
        this.destination = destination;
    }
