 ...
 */
public enum LegacyPolicyStatus {
    SUCCESS("SUCCESS"),
    ...
    LegacyPolicyStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static LegacyPolicyStatus fromValue(String value) {
        for (LegacyPolicyStatus b : LegacyPolicyStatus.values()) {
