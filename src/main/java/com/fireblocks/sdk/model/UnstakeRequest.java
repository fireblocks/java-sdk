...
public class UnstakeRequest {
    ...
    /**
     * Amount of tokens to unstake. Only supported for liquid staking (Lido) to enable partial
     * unstaking. For other chains, this field is ignored and the entire position will be unstaked.
     * If not provided, the entire position will be unstaked.
     *
     * @return amount
     */
    @jakarta.annotation.Nullable
