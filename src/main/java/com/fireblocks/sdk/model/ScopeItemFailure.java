...
/** ScopeItemFailure */
@JsonPropertyOrder({
    ScopeItemFailure.JSON_PROPERTY_PROVIDER_ID,
    ScopeItemFailure.JSON_PROPERTY_ACCOUNT_ID,
    ScopeItemFailure.JSON_PROPERTY_ERROR
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.14.0")
public class ScopeItemFailure {
    ...
    public ScopeItemFailure providerId(@jakarta.annotation.Nonnull String providerId) {
        this.providerId = providerId;
        return this;
    }

    /**
     * Identifier of the provider for which the request failed.
     *
     * @return providerId
     */
    ...
    public ScopeItemFailure accountId(@jakarta.annotation.Nullable String accountId) {
        this.accountId = accountId;
        return this;
    }

    /**
     * Identifier of the account for which the request failed (optional).
     *
     * @return accountId
     */
    ...
    public ScopeItemFailure error(@jakarta.annotation.Nonnull TradingErrorSchema error) {
        this.error = error;
        return this;
    }
    ...
    /** Return true if this ScopeItemFailure object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        ScopeItemFailure scopeItemFailure = (ScopeItemFailure) o;
        return Objects.equals(this.providerId, scopeItemFailure.providerId)
                && Objects.equals(this.accountId, scopeItemFailure.accountId)
                && Objects.equals(this.error, scopeItemFailure.error);
    }
