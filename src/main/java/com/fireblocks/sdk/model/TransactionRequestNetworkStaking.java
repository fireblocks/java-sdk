...
@JsonDeserialize(using = TransactionRequestNetworkStaking.TransactionRequestNetworkStakingDeserializer.class)
@JsonSerialize(using = TransactionRequestNetworkStaking.TransactionRequestNetworkStakingSerializer.class)
public class TransactionRequestNetworkStaking extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TransactionRequestNetworkStaking.class.getName());

    public static class TransactionRequestNetworkStakingSerializer extends StdSerializer<TransactionRequestNetworkStaking> {
        public TransactionRequestNetworkStakingSerializer(Class<TransactionRequestNetworkStaking> t) {
            super(t);
        }

        public TransactionRequestNetworkStakingSerializer() {
            this(null);
        }

        @Override
        public void serialize(TransactionRequestNetworkStaking value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransactionRequestNetworkStakingDeserializer extends StdDeserializer<TransactionRequestNetworkStaking> {
        public TransactionRequestNetworkStakingDeserializer() {
            this(TransactionRequestNetworkStaking.class);
        }

        public TransactionRequestNetworkStakingDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TransactionRequestNetworkStaking deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TransactionRequestNetworkStaking ret = new TransactionRequestNetworkStaking();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for TransactionRequestNetworkStaking: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TransactionRequestNetworkStaking getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TransactionRequestNetworkStaking cannot be null");
        }
    }
    ...
    public TransactionRequestNetworkStaking() {
        super("oneOf", Boolean.FALSE);
    }

    public TransactionRequestNetworkStaking(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TransactionRequestNetworkStaking(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TransactionRequestNetworkStaking.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return TransactionRequestNetworkStaking.schemas;
    }
