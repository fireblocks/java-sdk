...
public class ProviderDto {
  ...
  public static final String JSON_PROPERTY_IS_TERMS_OF_SERVICE_APPROVED = "isTermsOfServiceApproved";
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, providerDto.id) &&
        ...
        Objects.equals(this.isTermsOfServiceApproved, providerDto.isTermsOfServiceApproved);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, providerName, validators, iconUrl, termsOfServiceUrl, isTermsOfServiceApproved);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIconUrl() != null) {
      joiner.add(String.format("%siconUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIconUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `termsOfServiceUrl` to the URL query string
    if (getTermsOfServiceUrl() != null) {
      joiner.add(String.format("%stermsOfServiceUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTermsOfServiceUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `isTermsOfServiceApproved` to the URL query string
    if (getIsTermsOfServiceApproved() != null) {
      joiner.add(String.format("%sisTermsOfServiceApproved%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsTermsOfServiceApproved()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
