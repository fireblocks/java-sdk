...
public class PolicyRuleAmountAggregation {
    ...
    @jakarta.annotation.Nullable private AmountAggregationTimePeriodMethod operators;

    public static final String JSON_PROPERTY_SRC_TRANSFER_PEERS = "srcTransferPeers";
    @jakarta.annotation.Nullable private AmountAggregationTimePeriodMethod srcTransferPeers;

    public static final String JSON_PROPERTY_DST_TRANSFER_PEERS = "dstTransferPeers";
    @jakarta.annotation.Nullable private AmountAggregationTimePeriodMethod dstTransferPeers;

    public PolicyRuleAmountAggregation() {}

    public PolicyRuleAmountAggregation operators(
            @jakarta.annotation.Nullable AmountAggregationTimePeriodMethod operators) {
    ...
    public PolicyRuleAmountAggregation srcTransferPeers(
            @jakarta.annotation.Nullable AmountAggregationTimePeriodMethod srcTransferPeers) {
    ...
    public PolicyRuleAmountAggregation dstTransferPeers(
            @jakarta.annotation.Nullable AmountAggregationTimePeriodMethod dstTransferPeers) {
