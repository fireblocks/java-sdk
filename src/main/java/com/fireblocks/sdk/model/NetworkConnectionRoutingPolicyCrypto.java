...
public class NetworkConnectionRoutingPolicyCrypto extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NetworkConnectionRoutingPolicyCrypto.class.getName());

    public static class NetworkConnectionRoutingPolicyCryptoSerializer extends StdSerializer<NetworkConnectionRoutingPolicyCrypto> {
        public NetworkConnectionRoutingPolicyCryptoSerializer(Class<NetworkConnectionRoutingPolicyCrypto> t) {
            super(t);
        }

        public NetworkConnectionRoutingPolicyCryptoSerializer() {
            this(null);
        }

        @Override
        public void serialize(NetworkConnectionRoutingPolicyCrypto value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NetworkConnectionRoutingPolicyCryptoDeserializer extends StdDeserializer<NetworkConnectionRoutingPolicyCrypto> {
        public NetworkConnectionRoutingPolicyCryptoDeserializer() {
            this(NetworkConnectionRoutingPolicyCrypto.class);
        }

        public NetworkConnectionRoutingPolicyCryptoDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public NetworkConnectionRoutingPolicyCrypto deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                NetworkConnectionRoutingPolicyCrypto ret = new NetworkConnectionRoutingPolicyCrypto();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for NetworkConnectionRoutingPolicyCrypto: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NetworkConnectionRoutingPolicyCrypto getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NetworkConnectionRoutingPolicyCrypto cannot be null");
        }
    }
    ...
    public NetworkConnectionRoutingPolicyCrypto(CustomCryptoRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NetworkConnectionRoutingPolicyCrypto(DefaultNetworkRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NetworkConnectionRoutingPolicyCrypto(NoneNetworkRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * CustomCryptoRoutingDest, DefaultNetworkRoutingDest, NoneNetworkRoutingDest
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be CustomCryptoRoutingDest, DefaultNetworkRoutingDest, NoneNetworkRoutingDest");
    }
     ...
     * CustomCryptoRoutingDest, DefaultNetworkRoutingDest, NoneNetworkRoutingDest
     *
     * @return The actual instance (CustomCryptoRoutingDest, DefaultNetworkRoutingDest, NoneNetworkRoutingDest)
     */
    @Override
