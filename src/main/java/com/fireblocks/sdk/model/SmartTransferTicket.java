...
import com.fireblocks.sdk.model.SmartTransferTicketTerm;
...
public class SmartTransferTicket {
  ...
  public static final String JSON_PROPERTY_CANCELED_BY_NETWORK_ID_NAME = "canceledByNetworkIdName";
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, smartTransferTicket.id) &&
        ...
        Objects.equals(this.createdByNetworkIdName, smartTransferTicket.createdByNetworkIdName) &&
        Objects.equals(this.canceledByNetworkIdName, smartTransferTicket.canceledByNetworkIdName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, direction, status, terms, expiresIn, expiresAt, submittedAt, expiredAt, canceledAt, fulfilledAt, externalRefId, note, createdByNetworkId, createdByNetworkIdName, canceledByNetworkIdName, createdAt, updatedAt, canceledByMe, createdByMe);
  }
  ...
  public String toString() {
    ...
    sb.append("    createdByNetworkIdName: ").append(toIndentedString(createdByNetworkIdName)).append("\n");
    sb.append("    canceledByNetworkIdName: ").append(toIndentedString(canceledByNetworkIdName)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSubmittedAt() != null) {
      joiner.add(String.format("%ssubmittedAt%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSubmittedAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `expiredAt` to the URL query string
    if (getExpiredAt() != null) {
      joiner.add(String.format("%sexpiredAt%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExpiredAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `canceledAt` to the URL query string
    if (getCanceledAt() != null) {
      joiner.add(String.format("%scanceledAt%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCanceledAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `fulfilledAt` to the URL query string
    if (getFulfilledAt() != null) {
      joiner.add(String.format("%sfulfilledAt%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFulfilledAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCreatedByNetworkIdName() != null) {
      joiner.add(String.format("%screatedByNetworkIdName%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCreatedByNetworkIdName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `canceledByNetworkIdName` to the URL query string
    if (getCanceledByNetworkIdName() != null) {
      joiner.add(String.format("%scanceledByNetworkIdName%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCanceledByNetworkIdName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCanceledByMe() != null) {
      joiner.add(String.format("%scanceledByMe%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCanceledByMe()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `createdByMe` to the URL query string
    if (getCreatedByMe() != null) {
      joiner.add(String.format("%screatedByMe%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCreatedByMe()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
