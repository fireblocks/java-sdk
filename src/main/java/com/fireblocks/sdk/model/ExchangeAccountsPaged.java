...
public class ExchangeAccountsPaged {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExchangeAccount() != null) {
      for (int i = 0; i < getExchangeAccount().size(); i++) {
        if (getExchangeAccount().get(i) != null) {
          joiner.add(getExchangeAccount().get(i).toUrlQueryString(String.format("%sExchangeAccount%s%s", prefix, suffix,
    ...
    if (getPrevUrl() != null) {
      joiner.add(String.format("%sprevUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPrevUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
