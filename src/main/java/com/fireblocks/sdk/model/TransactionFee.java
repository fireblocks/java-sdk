...
public class TransactionFee {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(feePerByte, gasPrice, gasLimit, networkFee, baseFee, priorityFee, maxFeePerGasDelta, l1Fee);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMaxFeePerGasDelta() != null) {
      joiner.add(String.format("%smaxFeePerGasDelta%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxFeePerGasDelta()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `l1Fee` to the URL query string
    if (getL1Fee() != null) {
      joiner.add(String.format("%sl1Fee%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getL1Fee()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
