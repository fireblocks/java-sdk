...
public class NetworkIdRoutingPolicySenTest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NetworkIdRoutingPolicySenTest.class.getName());

    public static class NetworkIdRoutingPolicySenTestSerializer extends StdSerializer<NetworkIdRoutingPolicySenTest> {
        public NetworkIdRoutingPolicySenTestSerializer(Class<NetworkIdRoutingPolicySenTest> t) {
            super(t);
        }

        public NetworkIdRoutingPolicySenTestSerializer() {
            this(null);
        }

        @Override
        public void serialize(NetworkIdRoutingPolicySenTest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NetworkIdRoutingPolicySenTestDeserializer extends StdDeserializer<NetworkIdRoutingPolicySenTest> {
        public NetworkIdRoutingPolicySenTestDeserializer() {
            this(NetworkIdRoutingPolicySenTest.class);
        }

        public NetworkIdRoutingPolicySenTestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public NetworkIdRoutingPolicySenTest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                NetworkIdRoutingPolicySenTest ret = new NetworkIdRoutingPolicySenTest();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for NetworkIdRoutingPolicySenTest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NetworkIdRoutingPolicySenTest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NetworkIdRoutingPolicySenTest cannot be null");
        }
    }
    ...
    public NetworkIdRoutingPolicySenTest(CustomFiatRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NetworkIdRoutingPolicySenTest(NoneNetworkRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
