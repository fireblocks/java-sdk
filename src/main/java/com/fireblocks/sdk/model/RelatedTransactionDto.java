...
public class RelatedTransactionDto {
    ...
    public RelatedTransactionDto txId(@jakarta.annotation.Nonnull String txId) {
        this.txId = txId;
        return this;
    }
    ...
    public RelatedTransactionDto completed(@jakarta.annotation.Nonnull Boolean completed) {
        this.completed = completed;
        return this;
    }
