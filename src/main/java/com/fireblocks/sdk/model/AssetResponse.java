...
public class AssetResponse {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLegacyId() != null) {
      joiner.add(String.format("%slegacyId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLegacyId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `assetClass` to the URL query string
    if (getAssetClass() != null) {
      joiner.add(String.format("%sassetClass%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAssetClass()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
