...
@JsonDeserialize(using = TransactionRequestPriorityFee.TransactionRequestPriorityFeeDeserializer.class)
@JsonSerialize(using = TransactionRequestPriorityFee.TransactionRequestPriorityFeeSerializer.class)
public class TransactionRequestPriorityFee extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TransactionRequestPriorityFee.class.getName());

    public static class TransactionRequestPriorityFeeSerializer extends StdSerializer<TransactionRequestPriorityFee> {
        public TransactionRequestPriorityFeeSerializer(Class<TransactionRequestPriorityFee> t) {
            super(t);
        }

        public TransactionRequestPriorityFeeSerializer() {
            this(null);
        }

        @Override
        public void serialize(TransactionRequestPriorityFee value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransactionRequestPriorityFeeDeserializer extends StdDeserializer<TransactionRequestPriorityFee> {
        public TransactionRequestPriorityFeeDeserializer() {
            this(TransactionRequestPriorityFee.class);
        }

        public TransactionRequestPriorityFeeDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TransactionRequestPriorityFee deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TransactionRequestPriorityFee ret = new TransactionRequestPriorityFee();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for TransactionRequestPriorityFee: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TransactionRequestPriorityFee getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TransactionRequestPriorityFee cannot be null");
        }
    }
    ...
    public TransactionRequestPriorityFee(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TransactionRequestPriorityFee(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TransactionRequestPriorityFee.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return TransactionRequestPriorityFee.schemas;
    }
