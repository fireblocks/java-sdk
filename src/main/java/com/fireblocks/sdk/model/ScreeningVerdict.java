  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExecutionOperationId() != null) {
      joiner.add(String.format("%sexecutionOperationId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExecutionOperationId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
