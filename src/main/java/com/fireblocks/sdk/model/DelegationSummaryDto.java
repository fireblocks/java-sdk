    ...
    if (getActive() != null) {
      for (int i = 0; i < getActive().size(); i++) {
        if (getActive().get(i) != null) {
          joiner.add(getActive().get(i).toUrlQueryString(String.format("%sactive%s%s", prefix, suffix,
    ...
    if (getInactive() != null) {
      for (int i = 0; i < getInactive().size(); i++) {
        if (getInactive().get(i) != null) {
          joiner.add(getInactive().get(i).toUrlQueryString(String.format("%sinactive%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getRewardsAmount() != null) {
      for (int i = 0; i < getRewardsAmount().size(); i++) {
        if (getRewardsAmount().get(i) != null) {
          joiner.add(getRewardsAmount().get(i).toUrlQueryString(String.format("%srewardsAmount%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getTotalStaked() != null) {
      for (int i = 0; i < getTotalStaked().size(); i++) {
        if (getTotalStaked().get(i) != null) {
          joiner.add(getTotalStaked().get(i).toUrlQueryString(String.format("%stotalStaked%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
