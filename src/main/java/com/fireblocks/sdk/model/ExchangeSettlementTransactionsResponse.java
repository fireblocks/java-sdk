...
import com.fireblocks.sdk.model.ToCollateralTransaction;
import com.fireblocks.sdk.model.ToExchangeTransaction;
...
public class ExchangeSettlementTransactionsResponse {
  ...
  public ExchangeSettlementTransactionsResponse toExchange(List<ToExchangeTransaction> toExchange) {
    this.toExchange = toExchange;
    return this;
  }

  public ExchangeSettlementTransactionsResponse addToExchangeItem(ToExchangeTransaction toExchangeItem) {
  ...
  **/
  ...
  public ExchangeSettlementTransactionsResponse toCollateral(List<ToCollateralTransaction> toCollateral) {
    this.toCollateral = toCollateral;
    return this;
  }

  public ExchangeSettlementTransactionsResponse addToCollateralItem(ToCollateralTransaction toCollateralItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ExchangeSettlementTransactionsResponse exchangeSettlementTransactionsResponse = (ExchangeSettlementTransactionsResponse) o;
    return Objects.equals(this.toExchange, exchangeSettlementTransactionsResponse.toExchange) &&
        Objects.equals(this.toCollateral, exchangeSettlementTransactionsResponse.toCollateral);
  }
    ...
    if (getToExchange() != null) {
      for (int i = 0; i < getToExchange().size(); i++) {
        if (getToExchange().get(i) != null) {
          joiner.add(getToExchange().get(i).toUrlQueryString(String.format("%stoExchange%s%s", prefix, suffix,
    ...
    if (getToCollateral() != null) {
      for (int i = 0; i < getToCollateral().size(); i++) {
        if (getToCollateral().get(i) != null) {
          joiner.add(getToCollateral().get(i).toUrlQueryString(String.format("%stoCollateral%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
