...
public class NetworkIdRoutingPolicyValue extends AbstractOpenApiSchema {
    ...
    public static class NetworkIdRoutingPolicyValueSerializer extends StdSerializer<NetworkIdRoutingPolicyValue> {
        ...
        @Override
        public void serialize(NetworkIdRoutingPolicyValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NetworkIdRoutingPolicyValueDeserializer extends StdDeserializer<NetworkIdRoutingPolicyValue> {
        ...
        @Override
        public NetworkIdRoutingPolicyValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for NetworkIdRoutingPolicyValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NetworkIdRoutingPolicyValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NetworkIdRoutingPolicyValue cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(NetworkIdRoutingPolicyValue.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * CustomRoutingDest, NoneNetworkRoutingDest
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be CustomRoutingDest, NoneNetworkRoutingDest");
    }
