...
public class RewardInfo {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `srcRewards` to the URL query string
    if (getSrcRewards() != null) {
      joiner.add(String.format("%ssrcRewards%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSrcRewards()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `destRewards` to the URL query string
    if (getDestRewards() != null) {
      joiner.add(String.format("%sdestRewards%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestRewards()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
