...
public class MarketExecutionRequestDetails {
    ...
    public MarketExecutionRequestDetails type(@jakarta.annotation.Nonnull MarketTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public MarketExecutionRequestDetails side(@jakarta.annotation.Nonnull Side side) {
        this.side = side;
        return this;
    }
