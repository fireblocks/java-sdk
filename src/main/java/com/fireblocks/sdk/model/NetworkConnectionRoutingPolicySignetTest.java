...
@JsonDeserialize(using = NetworkConnectionRoutingPolicySignetTest.NetworkConnectionRoutingPolicySignetTestDeserializer.class)
@JsonSerialize(using = NetworkConnectionRoutingPolicySignetTest.NetworkConnectionRoutingPolicySignetTestSerializer.class)
public class NetworkConnectionRoutingPolicySignetTest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NetworkConnectionRoutingPolicySignetTest.class.getName());

    public static class NetworkConnectionRoutingPolicySignetTestSerializer extends StdSerializer<NetworkConnectionRoutingPolicySignetTest> {
        public NetworkConnectionRoutingPolicySignetTestSerializer(Class<NetworkConnectionRoutingPolicySignetTest> t) {
            super(t);
        }

        public NetworkConnectionRoutingPolicySignetTestSerializer() {
            this(null);
        }

        @Override
        public void serialize(NetworkConnectionRoutingPolicySignetTest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NetworkConnectionRoutingPolicySignetTestDeserializer extends StdDeserializer<NetworkConnectionRoutingPolicySignetTest> {
        public NetworkConnectionRoutingPolicySignetTestDeserializer() {
            this(NetworkConnectionRoutingPolicySignetTest.class);
        }

        public NetworkConnectionRoutingPolicySignetTestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public NetworkConnectionRoutingPolicySignetTest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                NetworkConnectionRoutingPolicySignetTest ret = new NetworkConnectionRoutingPolicySignetTest();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for NetworkConnectionRoutingPolicySignetTest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NetworkConnectionRoutingPolicySignetTest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NetworkConnectionRoutingPolicySignetTest cannot be null");
        }
    }
    ...
    public NetworkConnectionRoutingPolicySignetTest() {
        super("oneOf", Boolean.FALSE);
    }

    public NetworkConnectionRoutingPolicySignetTest(CustomFiatRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NetworkConnectionRoutingPolicySignetTest(DefaultNetworkRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NetworkConnectionRoutingPolicySignetTest(NoneNetworkRoutingDest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(NetworkConnectionRoutingPolicySignetTest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return NetworkConnectionRoutingPolicySignetTest.schemas;
    }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof DefaultNetworkRoutingDest) {
        if (getActualInstance() != null) {
          joiner.add(((DefaultNetworkRoutingDest)getActualInstance()).toUrlQueryString(prefix + "one_of_2" + suffix));
        }
        return joiner.toString();
    }
    return null;
