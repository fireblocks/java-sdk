 ...
 */
@JsonPropertyOrder({
  GetMaxSpendableAmountResponse.JSON_PROPERTY_MAX_SPENDABLE_AMOUNT
})
...
public class GetMaxSpendableAmountResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetMaxSpendableAmountResponse getMaxSpendableAmountResponse = (GetMaxSpendableAmountResponse) o;
    return Objects.equals(this.maxSpendableAmount, getMaxSpendableAmountResponse.maxSpendableAmount);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMaxSpendableAmount() != null) {
      joiner.add(String.format("%smaxSpendableAmount%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxSpendableAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
