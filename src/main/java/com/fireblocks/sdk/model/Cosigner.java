...
public class Cosigner {
    ...
    @jakarta.annotation.Nullable private VersionSummary version;
    ...
    public Cosigner version(@jakarta.annotation.Nullable VersionSummary version) {
    ...
    @JsonProperty(JSON_PROPERTY_VERSION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setVersion(@jakarta.annotation.Nullable VersionSummary version) {
        this.version = version;
    }
