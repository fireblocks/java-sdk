...
@JsonPropertyOrder({
    TravelRuleValidateLegalNameIdentifier.JSON_PROPERTY_LEGAL_PERSON_NAME,
    TravelRuleValidateLegalNameIdentifier.JSON_PROPERTY_LEGAL_PERSON_NAME_IDENTIFIER_TYPE
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.14.0")
public class TravelRuleValidateLegalNameIdentifier {
    public static final String JSON_PROPERTY_LEGAL_PERSON_NAME = "legalPersonName";
    @jakarta.annotation.Nonnull private String legalPersonName;

    /**
     * Specifies the type of name for a legal person (IVMS101 LegalPersonNameTypeCode). Acceptable
     * values are: - &#39;LEGL&#39;: Legal name - official name under which the organisation is
     * registered. - &#39;SHRT&#39;: Short name of the organisation. - &#39;TRAD&#39;: Trading name
     * - name used by the business for commercial purposes.
     */
    public enum LegalPersonNameIdentifierTypeEnum {
        LEGL(String.valueOf("LEGL")),

        SHRT(String.valueOf("SHRT")),

        TRAD(String.valueOf("TRAD"));
    ...
    public TravelRuleValidateLegalNameIdentifier() {}

    @JsonCreator
    public TravelRuleValidateLegalNameIdentifier(
            @JsonProperty(value = JSON_PROPERTY_LEGAL_PERSON_NAME, required = true)
                    String legalPersonName,
            @JsonProperty(value = JSON_PROPERTY_LEGAL_PERSON_NAME_IDENTIFIER_TYPE, required = true)
    ...
    public TravelRuleValidateLegalNameIdentifier legalPersonName(
            @jakarta.annotation.Nonnull String legalPersonName) {
        this.legalPersonName = legalPersonName;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_LEGAL_PERSON_NAME)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setLegalPersonName(@jakarta.annotation.Nonnull String legalPersonName) {
        this.legalPersonName = legalPersonName;
    }

    public TravelRuleValidateLegalNameIdentifier legalPersonNameIdentifierType(
            @jakarta.annotation.Nonnull
                    LegalPersonNameIdentifierTypeEnum legalPersonNameIdentifierType) {
        this.legalPersonNameIdentifierType = legalPersonNameIdentifierType;
        return this;
    ...
    /** Return true if this TravelRuleValidateLegalNameIdentifier object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        TravelRuleValidateLegalNameIdentifier travelRuleValidateLegalNameIdentifier =
                (TravelRuleValidateLegalNameIdentifier) o;
        return Objects.equals(
                        this.legalPersonName, travelRuleValidateLegalNameIdentifier.legalPersonName)
                && Objects.equals(
                        this.legalPersonNameIdentifierType,
                        travelRuleValidateLegalNameIdentifier.legalPersonNameIdentifierType);
    }
    ...
    public String toString() {
        ...
        sb.append("class TravelRuleValidateLegalNameIdentifier {\n");
