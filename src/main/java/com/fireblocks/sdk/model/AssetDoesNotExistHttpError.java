...
public class AssetDoesNotExistHttpError {
    ...
    public AssetDoesNotExistHttpError statusCode(@jakarta.annotation.Nullable Integer statusCode) {
    ...
    public AssetDoesNotExistHttpError message(@jakarta.annotation.Nullable String message) {
    ...
    public AssetDoesNotExistHttpError error(@jakarta.annotation.Nullable String error) {
        this.error = error;
        return this;
    }
