...
public class PolicyRuleAmount extends AbstractOpenApiSchema {
    ...
    public static class PolicyRuleAmountSerializer extends StdSerializer<PolicyRuleAmount> {
        public PolicyRuleAmountSerializer(Class<PolicyRuleAmount> t) {
            super(t);
        }
    ...
    public static class PolicyRuleAmountDeserializer extends StdDeserializer<PolicyRuleAmount> {
        ...
        public PolicyRuleAmount deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for PolicyRuleAmount: %d classes match result, expected 1", match));
        }
