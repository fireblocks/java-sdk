...
@JsonDeserialize(using = TransactionRequestGasLimit.TransactionRequestGasLimitDeserializer.class)
@JsonSerialize(using = TransactionRequestGasLimit.TransactionRequestGasLimitSerializer.class)
public class TransactionRequestGasLimit extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TransactionRequestGasLimit.class.getName());

    public static class TransactionRequestGasLimitSerializer extends StdSerializer<TransactionRequestGasLimit> {
        public TransactionRequestGasLimitSerializer(Class<TransactionRequestGasLimit> t) {
            super(t);
        }

        public TransactionRequestGasLimitSerializer() {
            this(null);
        }

        @Override
        public void serialize(TransactionRequestGasLimit value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransactionRequestGasLimitDeserializer extends StdDeserializer<TransactionRequestGasLimit> {
        public TransactionRequestGasLimitDeserializer() {
            this(TransactionRequestGasLimit.class);
        }

        public TransactionRequestGasLimitDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TransactionRequestGasLimit deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TransactionRequestGasLimit ret = new TransactionRequestGasLimit();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for TransactionRequestGasLimit: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TransactionRequestGasLimit getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TransactionRequestGasLimit cannot be null");
        }
    }
    ...
    public TransactionRequestGasLimit() {
        super("oneOf", Boolean.FALSE);
    }

    public TransactionRequestGasLimit(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TransactionRequestGasLimit(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TransactionRequestGasLimit.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return TransactionRequestGasLimit.schemas;
    }
