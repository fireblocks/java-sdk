...
public class DeployedContractNotFoundError {
    ...
    public DeployedContractNotFoundError message(@jakarta.annotation.Nonnull String message) {
        this.message = message;
        return this;
    }
    ...
    public DeployedContractNotFoundError code(@jakarta.annotation.Nonnull BigDecimal code) {
        this.code = code;
        return this;
    }
