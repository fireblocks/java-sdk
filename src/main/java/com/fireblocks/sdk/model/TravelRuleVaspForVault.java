...
public class TravelRuleVaspForVault {
    ...
    /** Return true if this TravelRuleVaspForVault object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        TravelRuleVaspForVault travelRuleVaspForVault = (TravelRuleVaspForVault) o;
        return Objects.equals(this.vaspDid, travelRuleVaspForVault.vaspDid);
    }

    @Override
    public int hashCode() {
        return Objects.hash(vaspDid);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class TravelRuleVaspForVault {\n");
    ...
    public String toUrlQueryString(String prefix) {
        ...
        // add `vaspDid` to the URL query string
        if (getVaspDid() != null) {
            joiner.add(
                    String.format(
                            "%svaspDid%s=%s",
