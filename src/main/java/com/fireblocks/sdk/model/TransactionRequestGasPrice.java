...
@JsonDeserialize(using = TransactionRequestGasPrice.TransactionRequestGasPriceDeserializer.class)
@JsonSerialize(using = TransactionRequestGasPrice.TransactionRequestGasPriceSerializer.class)
public class TransactionRequestGasPrice extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TransactionRequestGasPrice.class.getName());

    public static class TransactionRequestGasPriceSerializer extends StdSerializer<TransactionRequestGasPrice> {
        public TransactionRequestGasPriceSerializer(Class<TransactionRequestGasPrice> t) {
            super(t);
        }

        public TransactionRequestGasPriceSerializer() {
            this(null);
        }

        @Override
        public void serialize(TransactionRequestGasPrice value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TransactionRequestGasPriceDeserializer extends StdDeserializer<TransactionRequestGasPrice> {
        public TransactionRequestGasPriceDeserializer() {
            this(TransactionRequestGasPrice.class);
        }

        public TransactionRequestGasPriceDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TransactionRequestGasPrice deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TransactionRequestGasPrice ret = new TransactionRequestGasPrice();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for TransactionRequestGasPrice: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TransactionRequestGasPrice getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TransactionRequestGasPrice cannot be null");
        }
    }
    ...
    public TransactionRequestGasPrice() {
        super("oneOf", Boolean.FALSE);
    }

    public TransactionRequestGasPrice(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TransactionRequestGasPrice(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TransactionRequestGasPrice.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return TransactionRequestGasPrice.schemas;
    }
