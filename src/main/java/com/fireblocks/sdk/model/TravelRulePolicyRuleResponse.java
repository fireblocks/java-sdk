...
public class TravelRulePolicyRuleResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TravelRulePolicyRuleResponse travelRulePolicyRuleResponse = (TravelRulePolicyRuleResponse) o;
    return Objects.equals(this.sourceType, travelRulePolicyRuleResponse.sourceType) &&
        ...
        Objects.equals(this.networkProtocol, travelRulePolicyRuleResponse.networkProtocol) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceType, sourceSubType, destType, destSubType, destAddress, sourceId, destId, asset, baseAsset, amount, amountUSD, networkProtocol, operation, action);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSourceType() != null) {
      joiner.add(String.format("%ssourceType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSourceType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `sourceSubType` to the URL query string
    if (getSourceSubType() != null) {
      joiner.add(String.format("%ssourceSubType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSourceSubType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `destType` to the URL query string
    if (getDestType() != null) {
      joiner.add(String.format("%sdestType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `destSubType` to the URL query string
    if (getDestSubType() != null) {
      joiner.add(String.format("%sdestSubType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestSubType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `destAddress` to the URL query string
    if (getDestAddress() != null) {
      joiner.add(String.format("%sdestAddress%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestAddress()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getDestId() != null) {
      joiner.add(String.format("%sdestId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getBaseAsset() != null) {
      joiner.add(String.format("%sbaseAsset%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBaseAsset()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
