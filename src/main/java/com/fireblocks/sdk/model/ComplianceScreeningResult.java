  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBypassReason() != null) {
      joiner.add(String.format("%sbypassReason%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBypassReason()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `screeningStatus` to the URL query string
    if (getScreeningStatus() != null) {
      joiner.add(String.format("%sscreeningStatus%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getScreeningStatus()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
