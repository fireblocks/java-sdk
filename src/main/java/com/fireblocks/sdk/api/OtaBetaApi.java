...
public class OtaBetaApi {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<GetOtaStatusResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<GetOtaStatusResponse>() {}))
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<SetOtaStatusResponse>> setOtaStatus(SetOtaStatusRequest setOtaStatusRequest, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<SetOtaStatusResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<SetOtaStatusResponse>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
