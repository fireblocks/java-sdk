...
public class DeployedContractsApi {
  ...
  public CompletableFuture<ApiResponse<DeployedContractResponseDto>> getDeployedContractByAddress(String contractAddress, String assetId) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getDeployedContractByAddressRequestBuilder(contractAddress, assetId);
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getDeployedContractByAddress", localVarResponse));
            }
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<DeployedContractResponseDto>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<DeployedContractResponseDto>() {}))
              );
            } catch (IOException e) {
  ...
  private HttpRequest.Builder getDeployedContractByAddressRequestBuilder(String contractAddress, String assetId) throws ApiException {
    ...
    if (contractAddress == null) {
      throw new ApiException(400, "Missing the required parameter 'contractAddress' when calling getDeployedContractByAddress");
    }
    // verify the required parameter 'assetId' is set
    if (assetId == null) {
      throw new ApiException(400, "Missing the required parameter 'assetId' when calling getDeployedContractByAddress");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/contracts/{assetId}/{contractAddress}"
    ...
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getDeployedContractById", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder getDeployedContractByIdRequestBuilder(String id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getDeployedContractById");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/contracts/{id}"
  ...
  public CompletableFuture<ApiResponse<DeployedContractsPaginatedResponse>> getDeployedContracts(String pageCursor, BigDecimal pageSize, String contractAddress, String assetId, String templateId) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getDeployedContractsRequestBuilder(pageCursor, pageSize, contractAddress, assetId, templateId);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getDeployedContracts", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<DeployedContractsPaginatedResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<DeployedContractsPaginatedResponse>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
