...
public class ExchangeAccountsApi {
   ...
   */
  public CompletableFuture<ApiResponse<ConvertAssetsResponse>> convertAssets(String exchangeAccountId, ConvertAssetsRequest convertAssetsRequest, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<ConvertAssetsResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ConvertAssetsResponse>() {}))
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<ExchangeAccount>> getExchangeAccount(String exchangeAccountId) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<ExchangeAsset>> getExchangeAccountAsset(String exchangeAccountId, String assetId) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<List<ExchangeAccountsPaged>>> getPagedExchangeAccounts(BigDecimal limit, String before, String after) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<InternalTransferResponse>> internalTransfer(String exchangeAccountId, CreateInternalTransferRequest createInternalTransferRequest, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<InternalTransferResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<InternalTransferResponse>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
