...
public class Web3ConnectionsApi {
   ...
   */
  public CompletableFuture<ApiResponse<CreateConnectionResponse>> create(CreateConnectionRequest createConnectionRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = createRequestBuilder(createConnectionRequest, idempotencyKey);
  ...
  private HttpRequest.Builder createRequestBuilder(CreateConnectionRequest createConnectionRequest, String idempotencyKey) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<GetConnectionsResponse>> get(String order, GetFilterParameter filter, String sort, BigDecimal pageSize, String next) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Void>> submit(RespondToConnectionRequest respondToConnectionRequest, String id, String idempotencyKey) throws ApiException {
    try {
