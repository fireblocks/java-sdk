...
public class GasStationsApi {
   ...
   */
  public CompletableFuture<ApiResponse<GasStationPropertiesResponse>> getGasStationByAssetId(String assetId) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<GasStationPropertiesResponse>> getGasStationInfo() throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<EditGasStationConfigurationResponse>> updateGasStationConfiguration(GasStationConfiguration gasStationConfiguration, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<EditGasStationConfigurationResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<EditGasStationConfigurationResponse>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<EditGasStationConfigurationResponse>> updateGasStationConfigurationByAssetId(GasStationConfiguration gasStationConfiguration, String assetId, String idempotencyKey) throws ApiException {
    try {
