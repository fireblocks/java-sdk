...
public class AssetsApi {
   ...
   */
  public CompletableFuture<ApiResponse<JobCreated>> createAssetsBulk(CreateAssetsBulkRequest createAssetsBulkRequest, String idempotencyKey) throws ApiException {
    try {
