...
public class PaymentsPayoutApi {
   ...
   */
  public CompletableFuture<ApiResponse<PayoutResponse>> createPayout(CreatePayoutRequest createPayoutRequest, String idempotencyKey) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<DispatchPayoutResponse>> executePayoutAction(String payoutId, String idempotencyKey) throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<PayoutResponse>> getPayout(String payoutId) throws ApiException {
    try {
