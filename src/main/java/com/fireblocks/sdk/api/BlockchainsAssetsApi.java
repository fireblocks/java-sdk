...
public class BlockchainsAssetsApi {
   ...
   * @return CompletableFuture&lt;List&lt;AssetTypeResponse&gt;&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<List<AssetTypeResponse>> getSupportedAssets() throws ApiException {
    try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<List<AssetTypeResponse>>> getSupportedAssetsWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getSupportedAssetsRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
