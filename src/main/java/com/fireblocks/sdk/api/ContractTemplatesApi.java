...
public class ContractTemplatesApi {
  ...
  public CompletableFuture<ApiResponse<Void>> deleteContractTemplateById(String contractTemplateId) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteContractTemplateByIdRequestBuilder(contractTemplateId);
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteContractTemplateById", localVarResponse));
            }
  ...
  private HttpRequest.Builder deleteContractTemplateByIdRequestBuilder(String contractTemplateId) throws ApiException {
    ...
    if (contractTemplateId == null) {
      throw new ApiException(400, "Missing the required parameter 'contractTemplateId' when calling deleteContractTemplateById");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/templates/{contractTemplateId}"
        .replace("{contractTemplateId}", ApiClient.urlEncode(contractTemplateId.toString()));
  ...
  public CompletableFuture<ApiResponse<ContractDeployResponse>> deployContract(ContractDeployRequest contractDeployRequest, String contractTemplateId, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deployContractRequestBuilder(contractDeployRequest, contractTemplateId, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deployContract", localVarResponse));
            }
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<ContractDeployResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ContractDeployResponse>() {}))
              );
            } catch (IOException e) {
  ...
  private HttpRequest.Builder deployContractRequestBuilder(ContractDeployRequest contractDeployRequest, String contractTemplateId, String idempotencyKey) throws ApiException {
    ...
    if (contractDeployRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'contractDeployRequest' when calling deployContract");
    }
    // verify the required parameter 'contractTemplateId' is set
    if (contractTemplateId == null) {
      throw new ApiException(400, "Missing the required parameter 'contractTemplateId' when calling deployContract");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/templates/{contractTemplateId}/deploy"
        .replace("{contractTemplateId}", ApiClient.urlEncode(contractTemplateId.toString()));
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(contractDeployRequest);
  ...
  public CompletableFuture<ApiResponse<AbiFunction>> getConstructorByContractTemplateId(String contractTemplateId, Boolean withDocs) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getConstructorByContractTemplateIdRequestBuilder(contractTemplateId, withDocs);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getConstructorByContractTemplateId", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<AbiFunction>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<AbiFunction>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
  ...
  private HttpRequest.Builder getConstructorByContractTemplateIdRequestBuilder(String contractTemplateId, Boolean withDocs) throws ApiException {
    // verify the required parameter 'contractTemplateId' is set
    if (contractTemplateId == null) {
      throw new ApiException(400, "Missing the required parameter 'contractTemplateId' when calling getConstructorByContractTemplateId");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/templates/{contractTemplateId}/constructor"
        .replace("{contractTemplateId}", ApiClient.urlEncode(contractTemplateId.toString()));
  ...
  public CompletableFuture<ApiResponse<ContractTemplateDto>> getContractTemplateById(String contractTemplateId) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getContractTemplateByIdRequestBuilder(contractTemplateId);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getContractTemplateById", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<ContractTemplateDto>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ContractTemplateDto>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
  ...
  private HttpRequest.Builder getContractTemplateByIdRequestBuilder(String contractTemplateId) throws ApiException {
    // verify the required parameter 'contractTemplateId' is set
    if (contractTemplateId == null) {
      throw new ApiException(400, "Missing the required parameter 'contractTemplateId' when calling getContractTemplateById");
    }
   ...
   * @param pageSize Number of items per page, requesting more then max will return max items (optional)
   * @param type The type of the contract templates you wish to retrieve. Can accept one type, more or none (optional)
  ...
  public CompletableFuture<ApiResponse<TemplatesPaginatedResponse>> getContractTemplates(BigDecimal limit, BigDecimal offset, String pageCursor, BigDecimal pageSize, String type, String initializationPhase) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getContractTemplatesRequestBuilder(limit, offset, pageCursor, pageSize, type, initializationPhase);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getContractTemplates", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<TemplatesPaginatedResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<TemplatesPaginatedResponse>() {}))
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
  ...
  public CompletableFuture<ApiResponse<AbiFunction>> getFunctionAbiByContractTemplateId(String contractTemplateId, String functionSignature) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getFunctionAbiByContractTemplateIdRequestBuilder(contractTemplateId, functionSignature);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getFunctionAbiByContractTemplateId", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder getFunctionAbiByContractTemplateIdRequestBuilder(String contractTemplateId, String functionSignature) throws ApiException {
    // verify the required parameter 'contractTemplateId' is set
    if (contractTemplateId == null) {
      throw new ApiException(400, "Missing the required parameter 'contractTemplateId' when calling getFunctionAbiByContractTemplateId");
    }
    // verify the required parameter 'functionSignature' is set
    if (functionSignature == null) {
      throw new ApiException(400, "Missing the required parameter 'functionSignature' when calling getFunctionAbiByContractTemplateId");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/tokenization/templates/{contractTemplateId}/function"
        .replace("{contractTemplateId}", ApiClient.urlEncode(contractTemplateId.toString()));
  ...
  public CompletableFuture<ApiResponse<ContractTemplateDto>> uploadContractTemplate(ContractUploadRequest contractUploadRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = uploadContractTemplateRequestBuilder(contractUploadRequest, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (memberVarAsyncResponseInterceptor != null) {
            ...
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("uploadContractTemplate", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder uploadContractTemplateRequestBuilder(ContractUploadRequest contractUploadRequest, String idempotencyKey) throws ApiException {
    ...
    if (contractUploadRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'contractUploadRequest' when calling uploadContractTemplate");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(contractUploadRequest);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
