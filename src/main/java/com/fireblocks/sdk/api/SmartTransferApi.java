...
public class SmartTransferApi {
    ...
    /**
     * Set funding source and approval Set funding source for ticket term and creating approving
     * transaction for contract to transfer asset
     *
     ...
     * @return CompletableFuture&lt;ApiResponse&lt;SmartTransferTicketTermResponse&gt;&gt;, which
     ...
     *     times with the same idempotency key, the server will return the same response as the
     *     first request. The idempotency key is valid for 24 hours. (optional)
     * @return CompletableFuture&lt;ApiResponse&lt;SmartTransferTicketResponse&gt;&gt;, which
     *     completes exceptionally with an {@link ApiException} if the API call fails
     */
    public CompletableFuture<ApiResponse<SmartTransferTicketResponse>> cancelTicket(
            String ticketId, String idempotencyKey) {
        try {
            HttpRequest.Builder localVarRequestBuilder =
    ...
    /**
     * Create Ticket Creates a new Smart Transfer ticket. Learn more about Fireblocks Smart
     * Transfers [here](https://developers.fireblocks.com/docs/execute-smart-transfers). **Note:**
     * The &#x60;DVP&#x60; value is in Early Access and should only be used if Fireblocks has
     * enabled it in your workspace. Contact your Customer Success Manager for more information.
     ...
     *
     * @return CompletableFuture&lt;ApiResponse&lt;SmartTransferStatistic&gt;&gt;, which completes
                    ...
                    .handle(
                            (localVarApiResponse, localVarThrowable) ->
                                    localVarThrowable == null
                                            ? CompletableFuture.completedFuture(localVarApiResponse)
                                            : CompletableFuture
                                                    .<ApiResponse<SmartTransferStatistic>>
                                                            failedFuture(
                                                                    toApiFailure(
                                                                            localVarThrowable)))
                    .thenCompose(localVarNormalized -> localVarNormalized);
     ...
     *
     * @return CompletableFuture&lt;ApiResponse&lt;SmartTransferUserGroupsResponse&gt;&gt;, which
     *     completes exceptionally with an {@link ApiException} if the API call fails
     */
    ...
    /**
     * Find Ticket Find tickets by their title or ticker. You can also query all tickets without
     * filters by not providing any input parameters. **Endpoint Permissions:** Admin, Non-Signing
     * Admin, Signer, Approver, Editor, Viewer.
     *
