...
public class WhitelistIpAddressesApi {
   ...
   */
  public CompletableFuture<ApiResponse<GetWhitelistIpAddressesResponse>> getWhitelistIpAddresses(String userId) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<GetWhitelistIpAddressesResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<GetWhitelistIpAddressesResponse>() {}))
              );
            } catch (IOException e) {
