...
public class WebhooksApi {
   ...
   */
  public CompletableFuture<ApiResponse<ResendWebhooksByTransactionIdResponse>> resendTransactionWebhooks(ResendTransactionWebhooksRequest resendTransactionWebhooksRequest, String txId, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<ResendWebhooksByTransactionIdResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<ResendWebhooksByTransactionIdResponse>() {}))
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<ResendWebhooksResponse>> resendWebhooks(String idempotencyKey) throws ApiException {
    try {
