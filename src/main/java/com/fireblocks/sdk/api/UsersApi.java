...
public class UsersApi {
     ...
     *
     * @return CompletableFuture&lt;ApiResponse&lt;List&lt;UserResponse&gt;&gt;&gt;, which completes
     *     exceptionally with an {@link ApiException} if the API call fails
     */
    public CompletableFuture<ApiResponse<List<UserResponse>>> getUsers() {
        try {
                    ...
                    .handle(
                            (localVarApiResponse, localVarThrowable) ->
                                    localVarThrowable == null
                                            ...
                                            : CompletableFuture
                                                    .<ApiResponse<List<UserResponse>>>failedFuture(
