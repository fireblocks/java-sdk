...
public class ApiUserApi {
   ...
   */
  public CompletableFuture<ApiResponse<Void>> createApiUser(CreateAPIUser createAPIUser, String idempotencyKey) throws ApiException {
    try {
            ...
            try {
              ...
              return CompletableFuture.completedFuture(
                  new ApiResponse<GetAPIUsersResponse>(
                      ...
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<GetAPIUsersResponse>() {}))
              );
            } catch (IOException e) {
