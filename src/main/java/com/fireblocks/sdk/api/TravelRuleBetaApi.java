...
public class TravelRuleBetaApi {
   ...
   * @return CompletableFuture&lt;TravelRuleVASP&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<TravelRuleVASP> getVASPByDID(String did, String fields) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getVASPByDID", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<TravelRuleVASP>() {})
              );
            } catch (IOException e) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<TravelRuleVASP>> getVASPByDIDWithHttpInfo(String did, String fields) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getVASPByDIDRequestBuilder(did, fields);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
   ...
   * @param fields CSV of fields to return (all, \&quot;blank\&quot; or see list of all field names below) (optional)
   * @return CompletableFuture&lt;TravelRuleGetAllVASPsResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<TravelRuleGetAllVASPsResponse> getVASPs(String order, BigDecimal perPage, BigDecimal page, String fields) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getVASPsRequestBuilder(order, perPage, page, fields);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getVASPs", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<TravelRuleGetAllVASPsResponse>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<TravelRuleGetAllVASPsResponse>> getVASPsWithHttpInfo(String order, BigDecimal perPage, BigDecimal page, String fields) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getVASPsRequestBuilder(order, perPage, page, fields);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
   ...
   * @return CompletableFuture&lt;TravelRuleUpdateVASPDetails&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<TravelRuleUpdateVASPDetails> updateVasp(TravelRuleUpdateVASPDetails travelRuleUpdateVASPDetails, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = updateVaspRequestBuilder(travelRuleUpdateVASPDetails, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("updateVasp", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<TravelRuleUpdateVASPDetails>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<TravelRuleUpdateVASPDetails>> updateVaspWithHttpInfo(TravelRuleUpdateVASPDetails travelRuleUpdateVASPDetails, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = updateVaspRequestBuilder(travelRuleUpdateVASPDetails, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder updateVaspRequestBuilder(TravelRuleUpdateVASPDetails travelRuleUpdateVASPDetails, String idempotencyKey) throws ApiException {
    ...
    if (travelRuleUpdateVASPDetails == null) {
      throw new ApiException(400, "Missing the required parameter 'travelRuleUpdateVASPDetails' when calling updateVasp");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(travelRuleUpdateVASPDetails);
   ...
   * @param idempotencyKey A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours. (optional)
   * @return CompletableFuture&lt;TravelRuleValidateTransactionResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<TravelRuleValidateTransactionResponse> validateFullTravelRuleTransaction(TravelRuleValidateFullTransactionRequest travelRuleValidateFullTransactionRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = validateFullTravelRuleTransactionRequestBuilder(travelRuleValidateFullTransactionRequest, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("validateFullTravelRuleTransaction", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<TravelRuleValidateTransactionResponse>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<TravelRuleValidateTransactionResponse>> validateFullTravelRuleTransactionWithHttpInfo(TravelRuleValidateFullTransactionRequest travelRuleValidateFullTransactionRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = validateFullTravelRuleTransactionRequestBuilder(travelRuleValidateFullTransactionRequest, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder validateFullTravelRuleTransactionRequestBuilder(TravelRuleValidateFullTransactionRequest travelRuleValidateFullTransactionRequest, String idempotencyKey) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(travelRuleValidateFullTransactionRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<TravelRuleValidateTransactionResponse> validateTravelRuleTransaction(TravelRuleValidateTransactionRequest travelRuleValidateTransactionRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = validateTravelRuleTransactionRequestBuilder(travelRuleValidateTransactionRequest, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("validateTravelRuleTransaction", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<TravelRuleValidateTransactionResponse>> validateTravelRuleTransactionWithHttpInfo(TravelRuleValidateTransactionRequest travelRuleValidateTransactionRequest, String idempotencyKey) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = validateTravelRuleTransactionRequestBuilder(travelRuleValidateTransactionRequest, idempotencyKey);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder validateTravelRuleTransactionRequestBuilder(TravelRuleValidateTransactionRequest travelRuleValidateTransactionRequest, String idempotencyKey) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(travelRuleValidateTransactionRequest);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
