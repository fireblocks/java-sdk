...
import org.openapitools.client.model.ExchangeTradingAccount;
import org.openapitools.client.model.ExchangeType;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsSubaccount() != null) {
      try {
        joiner.add(String.format("%sisSubaccount%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsSubaccount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getMainAccountId() != null) {
      try {
        joiner.add(String.format("%smainAccountId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMainAccountId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
