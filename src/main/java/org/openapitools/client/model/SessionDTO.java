...
import org.openapitools.client.model.SessionDTOSessionMetadata;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConnectionType() != null) {
      try {
        joiner.add(String.format("%sconnectionType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getConnectionType()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
