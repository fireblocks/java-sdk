...
import org.openapitools.client.model.AmountInfo;
...
import org.openapitools.client.model.FeeInfo;
import org.openapitools.client.model.GetTransactionOperation;
import org.openapitools.client.model.NetworkRecord;
import org.openapitools.client.model.RewardInfo;
import org.openapitools.client.model.SignedMessage;
import org.openapitools.client.model.SourceTransferPeerPathResponse;
import org.openapitools.client.model.SystemMessageInfo;
import org.openapitools.client.model.TransactionResponseContractCallDecodedData;
import org.openapitools.client.model.TransactionResponseDestination;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExternalTxId() != null) {
      try {
        joiner.add(String.format("%sexternalTxId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExternalTxId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getSubStatus() != null) {
      try {
        joiner.add(String.format("%ssubStatus%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSubStatus()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAssetId() != null) {
      try {
        joiner.add(String.format("%sassetId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAssetId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getSourceAddress() != null) {
      try {
        joiner.add(String.format("%ssourceAddress%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSourceAddress()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDestinationAddress() != null) {
      try {
        joiner.add(String.format("%sdestinationAddress%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestinationAddress()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDestinationAddressDescription() != null) {
      try {
        joiner.add(String.format("%sdestinationAddressDescription%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestinationAddressDescription()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDestinationTag() != null) {
      try {
        joiner.add(String.format("%sdestinationTag%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestinationTag()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTreatAsGrossAmount() != null) {
      try {
        joiner.add(String.format("%streatAsGrossAmount%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTreatAsGrossAmount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
      ...
      for (int i = 0; i < getSignedBy().size(); i++) {
        try {
          joiner.add(String.format("%ssignedBy%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
              URLEncoder.encode(String.valueOf(getSignedBy().get(i)), "UTF-8").replaceAll("\\+", "%20")));
        } catch (UnsupportedEncodingException e) {
          // Should never happen, UTF-8 is always supported
          throw new RuntimeException(e);
        }
    ...
    if (getRejectedBy() != null) {
      try {
        joiner.add(String.format("%srejectedBy%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRejectedBy()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getExchangeTxId() != null) {
      try {
        joiner.add(String.format("%sexchangeTxId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExchangeTxId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getExtraParameters() != null) {
      try {
        joiner.add(String.format("%sextraParameters%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExtraParameters()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
