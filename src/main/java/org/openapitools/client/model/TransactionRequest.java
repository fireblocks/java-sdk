...
public class TransactionRequest {
  ...
  **/
  ...
  public TransactionRequest source(TransferPeerPath source) {
  ...
  **/
  ...
  public TransferPeerPath getSource() {
    return source;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(TransferPeerPath source) {
    this.source = source;
  }
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getForceSweep() != null) {
      try {
        joiner.add(String.format("%sforceSweep%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getForceSweep()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getFailOnLowFee() != null) {
      try {
        joiner.add(String.format("%sfailOnLowFee%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFailOnLowFee()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getMaxFee() != null) {
      try {
        joiner.add(String.format("%smaxFee%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMaxFee()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getReplaceTxByHash() != null) {
      try {
        joiner.add(String.format("%sreplaceTxByHash%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getReplaceTxByHash()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAutoStaking() != null) {
      try {
        joiner.add(String.format("%sautoStaking%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAutoStaking()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
