  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSrcRewards() != null) {
      try {
        joiner.add(String.format("%ssrcRewards%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSrcRewards()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getDestRewards() != null) {
      try {
        joiner.add(String.format("%sdestRewards%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDestRewards()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
