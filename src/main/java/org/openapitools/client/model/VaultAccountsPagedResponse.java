  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPreviousUrl() != null) {
      try {
        joiner.add(String.format("%spreviousUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPreviousUrl()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getNextUrl() != null) {
      try {
        joiner.add(String.format("%snextUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNextUrl()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
