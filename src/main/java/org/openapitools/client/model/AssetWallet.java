...
public class AssetWallet {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVaultId() != null) {
      try {
        joiner.add(String.format("%svaultId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVaultId()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getCreationTimestamp() != null) {
      try {
        joiner.add(String.format("%screationTimestamp%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCreationTimestamp()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
