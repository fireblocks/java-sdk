  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFeePerByte() != null) {
      try {
        joiner.add(String.format("%sfeePerByte%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFeePerByte()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getGasLimit() != null) {
      try {
        joiner.add(String.format("%sgasLimit%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getGasLimit()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBaseFee() != null) {
      try {
        joiner.add(String.format("%sbaseFee%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBaseFee()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getPriorityFee() != null) {
      try {
        joiner.add(String.format("%spriorityFee%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPriorityFee()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
