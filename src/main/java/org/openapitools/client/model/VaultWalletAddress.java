  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAddressFormat() != null) {
      try {
        joiner.add(String.format("%saddressFormat%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressFormat()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUserDefined() != null) {
      try {
        joiner.add(String.format("%suserDefined%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUserDefined()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
