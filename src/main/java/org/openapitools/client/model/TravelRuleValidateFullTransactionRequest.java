...
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestBeneficiary;
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestBeneficiaryProof;
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestOriginator;
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestOriginatorProof;
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestPii;
import org.openapitools.client.model.TravelRuleValidateFullTransactionRequestTransactionBlockchainInfo;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTransactionAsset() != null) {
      try {
        joiner.add(String.format("%stransactionAsset%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTransactionAsset()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getOriginatorDid() != null) {
      try {
        joiner.add(String.format("%soriginatorDid%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOriginatorDid()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBeneficiaryDid() != null) {
      try {
        joiner.add(String.format("%sbeneficiaryDid%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBeneficiaryDid()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getOriginatorVASPdid() != null) {
      try {
        joiner.add(String.format("%soriginatorVASPdid%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOriginatorVASPdid()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getNotificationEmail() != null) {
      try {
        joiner.add(String.format("%snotificationEmail%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNotificationEmail()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getSkipBeneficiaryDataValidation() != null) {
      try {
        joiner.add(String.format("%sskipBeneficiaryDataValidation%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSkipBeneficiaryDataValidation()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleBehavior() != null) {
      try {
        joiner.add(String.format("%stravelRuleBehavior%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleBehavior()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
