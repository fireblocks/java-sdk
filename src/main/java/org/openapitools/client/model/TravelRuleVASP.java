...
import org.openapitools.client.model.TravelRuleIssuers;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVerificationStatus() != null) {
      try {
        joiner.add(String.format("%sverificationStatus%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVerificationStatus()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAddressLine1() != null) {
      try {
        joiner.add(String.format("%saddressLine1%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressLine1()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getAddressLine2() != null) {
      try {
        joiner.add(String.format("%saddressLine2%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressLine2()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getEmailDomains() != null) {
      try {
        joiner.add(String.format("%semailDomains%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEmailDomains()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLegalStructure() != null) {
      try {
        joiner.add(String.format("%slegalStructure%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLegalStructure()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getYearFounded() != null) {
      try {
        joiner.add(String.format("%syearFounded%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getYearFounded()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIsRegulated() != null) {
      try {
        joiner.add(String.format("%sisRegulated%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsRegulated()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getOtherNames() != null) {
      try {
        joiner.add(String.format("%sotherNames%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOtherNames()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIdentificationType() != null) {
      try {
        joiner.add(String.format("%sidentificationType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIdentificationType()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIdentificationCountry() != null) {
      try {
        joiner.add(String.format("%sidentificationCountry%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIdentificationCountry()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBusinessNumber() != null) {
      try {
        joiner.add(String.format("%sbusinessNumber%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBusinessNumber()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getRegulatoryAuthorities() != null) {
      try {
        joiner.add(String.format("%sregulatoryAuthorities%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRegulatoryAuthorities()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getJurisdictions() != null) {
      try {
        joiner.add(String.format("%sjurisdictions%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getJurisdictions()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getCertificates() != null) {
      try {
        joiner.add(String.format("%scertificates%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCertificates()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleOPENVASP() != null) {
      try {
        joiner.add(String.format("%stravelRule_OPENVASP%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleOPENVASP()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleSYGNA() != null) {
      try {
        joiner.add(String.format("%stravelRule_SYGNA%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleSYGNA()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleTRISA() != null) {
      try {
        joiner.add(String.format("%stravelRule_TRISA%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleTRISA()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleTRLIGHT() != null) {
      try {
        joiner.add(String.format("%stravelRule_TRLIGHT%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleTRLIGHT()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleEMAIL() != null) {
      try {
        joiner.add(String.format("%stravelRule_EMAIL%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleEMAIL()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleTRP() != null) {
      try {
        joiner.add(String.format("%stravelRule_TRP%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleTRP()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleSHYFT() != null) {
      try {
        joiner.add(String.format("%stravelRule_SHYFT%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleSHYFT()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getTravelRuleUSTRAVELRULEWG() != null) {
      try {
        joiner.add(String.format("%stravelRule_USTRAVELRULEWG%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTravelRuleUSTRAVELRULEWG()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getUpdatedBy() != null) {
      try {
        joiner.add(String.format("%supdatedBy%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUpdatedBy()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLastSentDate() != null) {
      try {
        joiner.add(String.format("%slastSentDate%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLastSentDate()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getLastReceivedDate() != null) {
      try {
        joiner.add(String.format("%slastReceivedDate%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLastReceivedDate()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getDocuments() != null) {
      try {
        joiner.add(String.format("%sdocuments%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDocuments()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getHasAdmin() != null) {
      try {
        joiner.add(String.format("%shasAdmin%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getHasAdmin()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getIsNotifiable() != null) {
      try {
        joiner.add(String.format("%sisNotifiable%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsNotifiable()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
