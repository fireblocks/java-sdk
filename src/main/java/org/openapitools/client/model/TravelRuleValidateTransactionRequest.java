...
import org.openapitools.client.model.TravelRuleValidateTransactionRequestBeneficiaryAddress;
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOriginatorEqualsBeneficiary() != null) {
      try {
        joiner.add(String.format("%soriginatorEqualsBeneficiary%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getOriginatorEqualsBeneficiary()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBeneficiaryName() != null) {
      try {
        joiner.add(String.format("%sbeneficiaryName%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBeneficiaryName()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    if (getBeneficiaryAccountNumber() != null) {
      try {
        joiner.add(String.format("%sbeneficiaryAccountNumber%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBeneficiaryAccountNumber()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
